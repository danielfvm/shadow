...
var LiveWallpaper = GObject.registerClass(
    class LiveWallpaper extends St.Widget {
        ...
        _applyWallpaper() {
            let wallpaper = new Clutter.Actor({
            ...
            if (this._renderer == null && renderer != null) {
                this._renderer = renderer;
                this._wallpaper = wallpaper;
                this._wallpaper.layout_manager.add_window(this._renderer);
                this.add_child(this._wallpaper);
                this._fade();
            } else if (this._renderer != null) {
                this._wallpaper.layout_manager.remove_window(this._renderer);
                this._renderer = null;
                this.remove_child(this._wallpaper);
            }
